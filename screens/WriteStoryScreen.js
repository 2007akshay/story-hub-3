...
import { StyleSheet, TouchableOpacity, Text, View, KeyboardAvoidingView, ToastAndroid } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  storyText: { height: 250, borderWidth: 2, margin: 10, padding: 6 },
  submitButton: {
